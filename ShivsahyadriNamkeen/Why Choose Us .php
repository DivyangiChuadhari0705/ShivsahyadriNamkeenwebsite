...
#quality-page .feature-card {
  ...
  #quality-page .feature-card:hover {
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link active" href="Why Choose Us .php">Why Choose Us?</a></li>
...
<section class="hero position-relative text-center text-white bg-hero d-flex align-items-center justify-content-center">
  ...
  <div class="hero-content position-relative">
    <h1 class="display-5 fw-bold mb-3">Why Choose Us</h1>
...
<main id="quality-page" class="py-5 bg-light">
  <div class="container">

    <!-- Page Header -->
    <header class="text-center mb-5">
      <h1 class="display-5 fw-bold text-primary">Why Choose Us / Quality Promise</h1>
      <p class="lead text-muted">
        At Shivsahyadri Namkeen, we believe quality speaks louder than words.
      </p>
    </header>
...
<div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 text-center">
  ...
  <div class="col">
    <div class="card h-100 shadow-sm border-0 feature-card">
      <img src="https://cdn.vectorstock.com/i/500p/67/27/natural-ingredients-or-all-vector-54256727.jpg" class="card-img-top" alt="Premium Ingredients">
      <div class="card-body">
        <h5 class="card-title fw-bold">Premium Ingredients</h5>
        <p class="card-text">
          Made with premium quality ingredients for authentic taste.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="col">
    <div class="card h-100 shadow-sm border-0 feature-card">
      <img src="https://img.freepik.com/premium-vector/hygienic-illustration-vector-design_675292-78.jpg" class="card-img-top" alt="100% Hygienic">
      <div class="card-body">
        <h5 class="card-title fw-bold">100% Hygienic</h5>
        <p class="card-text">
          Prepared in a 100% hygienic and safe environment.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="col">
    <div class="card h-100 shadow-sm border-0 feature-card">
      <img src="https://heerson.com/cdn/shop/collections/Farali_Chiwda_2_-_Copy_2.jpg?v=1715694146" class="card-img-top" alt="Traditional Recipes">
      <div class="card-body">
        <h5 class="card-title fw-bold">Traditional Recipes</h5>
        <p class="card-text">
  ...
  <div class="col">
    <div class="card h-100 shadow-sm border-0 feature-card">
      <img src="https://tiimg.tistatic.com/fp/1/007/867/100-percent-fresh-spicy-salty-indian-snacks-garlic-mixture-namkeen-833.jpg" class="card-img-top" alt="Fresh Batches Daily">
      <div class="card-body">
        <h5 class="card-title fw-bold">Fresh Batches Daily</h5>
        <p class="card-text">
          Every batch is prepared fresh daily to ensure taste.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="col">
    <div class="card h-100 shadow-sm border-0 feature-card">
      <img src="https://img.freepik.com/premium-vector/no-added-preservatives-logo-preservatives-free-natural-product-symbol_349999-1072.jpg?semt=ais_hybrid&w=740" class="card-img-top" alt="No Preservatives">
      <div class="card-body">
        <h5 class="card-title fw-bold">No Preservatives</h5>
        <p class="card-text">
          No artificial preservatives, ensuring natural freshness.
        </p>
      </div>
    </div>
  </div>
    ...
    <div class="text-center mt-5">
      <h4 class="fw-bold text-dark">
        "At Shivsahyadri Namkeen, quality isn’t a choice – it’s our identity."
      </h4>
    </div>
